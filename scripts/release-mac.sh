...
REPO_NAME="SuperMarioWorldRecomp"      # GitHub repo / zip basename
APP_NAME="Super Mario World"        # .app display name (may contain spaces)
TARGET="SuperMarioWorldRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="snes"            # nes | snes | genesis | vb | psx
VERSION="v0.8.2-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Super Mario World (USA) .sfc dump"        # human description of the ROM the user must supply
# ==============================================
